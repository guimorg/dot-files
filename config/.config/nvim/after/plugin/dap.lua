...
vim.keymap.set("n", "<leader>dsi", '<cmd>lua require"dap".step_into()<CR>', { desc = "[D]ap [S]tep [I]nto" })
vim.keymap.set(
	"n",
	"<leader>dtb",
	'<cmd>lua require"dap".toggle_breakpoint()<CR>',
	{ desc = "[D]ap [T]oggle [B]reakpoint" }
)
--
...
vim.keymap.set(
	...
	{ desc = "[D]ap [C][O]nfigurations" }
)
vim.keymap.set(
	"n",
	"<leader>dlb",
	'<cmd>lua require"telescope".extensions.dap.list_breakpoints{}<CR>',
	{ desc = "[D]ap [L]ist [B]reakpoints" }
)
vim.keymap.set(
	"n",
	"<leader>dv",
