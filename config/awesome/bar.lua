...
awful.screen.connect_for_each_screen(function(s)
    ...
    myclock = awful.widget.textclock(
        '<span font="Fire Code Retina 8"> %H:%M </span>', 5
    )
    ...
    s.wibar:setup {
        ...
        { -- Right widgets
            layout = wibox.layout.fixed.horizontal,
            wibox.layout.margin(gitlab_widget({timeout=600}), 10, 10, 10, 10),
            -- wibox.layout.margin(cpu_widget({width=10, step_width=1}), 10, 10, 10, 10),
            -- wibox.layout.margin(ram_widget({widget_show_buf=true}), 10, 10, 10, 10),
            wibox.layout.margin(volume_widget({widget_type="arc"}), 10, 10, 10, 10),
            wibox.layout.margin(mykeyboardlayout, 10, 10, 10, 10),
            wibox.layout.margin(mysystray, 10, 10, 10, 10),
            wibox.layout.margin(battery_widget(), 0, 10, 10, 10),
            wibox.layout.margin(vpnwidget, 0, 10, 10, 10),
